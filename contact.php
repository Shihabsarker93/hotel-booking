...
<!-- real line >-->
    <section class="hero-wrap hero-wrap-2" style="background-image: url('images/image_2.jpg');" data-stellar-background-ratio="0.5"> 
		<!-- <section class="hero-wrap hero-wrap-2" style="background-image: url('images/moon.JPEG');" data-stellar-background-ratio="0.5"> -->
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
			...
			<h1 class="mb-0 bread" style="color: white;">Via Email: test@gmail.com</h1>
